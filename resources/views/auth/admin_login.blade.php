            ...
            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" name='email', id='email' :value="old('email')" required autofocus autocomplete="username" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" name='password', id='password' required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
