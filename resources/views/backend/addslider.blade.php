					  ...
					  <table id="example5" class="table table-bordered table-striped" style="width:100%">
                        ...
                        @foreach($data as $key => $slider)
							...
							<tr>
                                ...
                                <td>{{$slider->desc}}</td>
                                <td>
                                <img  src="{{asset($slider->slider_image)}}" id='newimage' alt="error" style='width:100px; Height:100px; border-radius:30px'>
                                </td>
                            
                                <td>
                                @if($slider->status == 1)

                                <a class='btn btn-primary' href="{{route('slider.deactive',$slider->id)}}">Activate</a>

                                @else

                                <a class='btn btn-primary' href="{{route('slider.active',$slider->id)}}">Deactivate</a>
                                ...
                                <td>
                                    ...
                                    <a class='btn btn-success' href="{{route('slider.del', $slider->id)}}">Delete</a>
                                </td>
					  ...
					  <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <div class="form-group col-12">
								...
								<div class="controls">
									<input type="file" name="simage" class="form-control" required data-validation-required-message="This field is required"> </div>
							</div>
