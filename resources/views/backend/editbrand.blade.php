                     ...
                     @csrf   
                      ...
                      <input type="hidden" value="{{$data->image}}" name='old_image'>
                            ...
                            <div class="form-group col-3">
								...
								<div class="controls">
									<input type="text" value="{{$data->name_eng}}" name="beng" class="form-control" required data-validation-required-message="This field is required"> </div>
                            ...
                            <div class="form-group col-3">
								...
								<div class="controls">
									<input  type="text" value="{{$data->name_urdu}}" name="burdu" class="form-control" required data-validation-required-message="This field is required"> </div>
