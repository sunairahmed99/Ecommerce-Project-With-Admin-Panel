			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">View All Pending Orders</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					  ...
					  <table id="example5" class="table table-bordered table-striped" style="width:100%">
                        ...
                        @foreach($order as $key => $order)
							...
							<tr>
                                ...
                                <td>
                                    <a class='btn btn-success' href="{{route('view.order',$order->id)}}">View</a>
									<a class='btn btn-success' href="{{route('p.order',$order->id)}}">Processing order</a>
