    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview {{($prefix == '/brands')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Brands</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('view.brands')}}"><i class="ti-more"></i>view brands</a></li>
        ...
        <li class="treeview {{($prefix == '/categories')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Categories</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('view.cat')}}"><i class="ti-more"></i>view categories</a></li>
            
          </ul>
        </li>

        <li class="treeview {{($prefix == '/subcategories')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Sub Categories</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('view.subcat')}}"><i class="ti-more"></i>view Subcategories</a></li>
            
          </ul>
        </li>

        <li class="treeview {{($prefix == '/Subsubcategories')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Sub SubCat</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('view.sub.subcat')}}"><i class="ti-more"></i>view Sub Subcategories</a></li>
        ...
        <li class="treeview {{($prefix == '/Products')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage All Products</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('view.products')}}"><i class="ti-more"></i>view All Products</a></li>
            <li><a href="{{route('add.product')}}"><i class="ti-more"></i>Add All Products</a></li>
            
          </ul>
        </li>

        <li class="treeview {{($route == '/coupon/view')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Coupons</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('coupon.view')}}"><i class="ti-more"></i>view Coupons</a></li>
            
          </ul>
        </li>

        <li class="treeview {{($route == '/Division/view')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Shipping</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('division.view')}}"><i class="ti-more"></i>view Division</a></li>
            
            
          </ul>
        </li>

        <li class="treeview {{($route == '/area/view')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Area</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('area.view')}}"><i class="ti-more"></i>view Area</a></li>
            
          </ul>
        </li>

        <li class="treeview {{($route == '/state/view')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage State</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('state.view')}}"><i class="ti-more"></i>view State</a></li>
        ...
        <li class="treeview {{($prefix == '/slider')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Slider</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href=""><i class="ti-more"></i>view All slider</a></li>
            <li><a href="{{route('add.slider')}}"><i class="ti-more"></i>Add Slider</a></li>
            
          </ul>
        </li>

        <li class="treeview {{($route == 'pending.order')? 'active': ''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Orders</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('pending.order')}}"><i class="ti-more"></i>view All Pending Orders</a></li>
            <li><a href="{{route('confirmed.order')}}"><i class="ti-more"></i>view All Confirm Orders</a></li>
            <li><a href="{{route('process.order')}}"><i class="ti-more"></i>view All processing Orders</a></li>
            <li><a href="{{route('picked.order')}}"><i class="ti-more"></i>view All picked Orders</a></li>
            <li><a href="{{route('shiped.order')}}"><i class="ti-more"></i>view All shiped Orders</a></li>
            <li><a href="{{route('delivered.order')}}"><i class="ti-more"></i>view All delivered Orders</a></li>
            <li><a href="{{route('cancel.order')}}"><i class="ti-more"></i>view All cancel Orders</a></li>
          </ul>
        </li>
        ...
        <li class="treeview {{($route == 'pending.order')? 'active': ''}}">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('all.reports')}}"><i class="ti-more"></i>view All Reports</a></li>
        ...
        <li class="treeview {{($route == 'pending.order')? 'active': ''}}">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('all.users')}}"><i class="ti-more"></i>view All Users</a></li>
