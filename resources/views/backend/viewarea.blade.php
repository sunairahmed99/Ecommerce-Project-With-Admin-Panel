		...
		<section class="content">
		  <div class="row">
					  ...
					  <table id="example5" class="table table-bordered table-striped" style="width:100%">
                        ...
                        @foreach($data as $key => $area)
							...
							<tr>
                                ...
                                <td>
                                    <a class='btn btn-success' href="{{route('area.edit',$area->id)}}">Edit</a>
                                    <a class='btn btn-success' href="{{route('area.del', $area->id)}}">Delete</a>
                                </td>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form  method='post' action="{{route('add.area')}}" enctype='multipart/form-data'>
                     @csrf   
					  <div class="row">
						<div class="col-12">	
                        ...
                        <div class="form-group col-12">
								...
								<div class="controls">
									<input type="text" name="area" class="form-control" required data-validation-required-message="This field is required"> </div>
