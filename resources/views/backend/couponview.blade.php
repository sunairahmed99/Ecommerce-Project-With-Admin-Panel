			...
			<div class="col-8">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">View All COupons</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
                        ...
                        @foreach($coupon as $key => $data)
							...
							<tr>
                                ...
                                <td style='width:15rem'>
                                    <a class='btn btn-success' href="{{route('coupon.edit',$data->id)}}">Edit</a>
                                    <a class='btn btn-success' href="{{route('coupon.del',$data->id)}}">Delete</a>
                                </td>
                     ...
                     @csrf   
					  <div class="row">
                        ...
                        <div class="form-group col-12">
								...
								<div class="controls">
									<input type="text" name="cname" class="form-control" required data-validation-required-message="This field is required"> </div>
                            ...
                            <div class="form-group col-12">
								...
								<div class="controls">
									<input type="text" name="cdis" class="form-control" required data-validation-required-message="This field is required"> </div>
                            ...
                            <div class="form-group col-12">
								...
								<div class="controls">
									<input type="Date" name="cvalidity" class="form-control" required data-validation-required-messge="This field is required"> </div>
							</div>
