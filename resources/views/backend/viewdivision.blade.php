		...
		<section class="content">
		  <div class="row">
                        ...
                        @foreach($shipping as $key => $data)
							...
							<tr>
                                ...
                                <td style='width:15rem'>
                                    <a class='btn btn-success' href="{{route('shipping.edit',$data->id)}}">Edit</a>
                                    <a class='btn btn-success' href="{{route('shipping.del',$data->id)}}">Delete</a>
                                </td>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form  method='post' action="{{route('division.add')}}" enctype='multipart/form-data'>
                     @csrf   
					  <div class="row">
						<div class="col-12">	
                        ...
                        <div class="form-group col-12">
								...
								<div class="controls">
									<input type="text" name="dname" class="form-control" required data-validation-required-message="This field is required"> </div>
