    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $.each(response, function(key,value){
          miniwish += `  
          <tr>
					<td class="col-md-2"><img src="/${value.pro.pro_thumbnail}" alt="imga"></td>
					<td class="col-md-7">
						<div class="product-name"><a href="/pro/detail/${value.pro.id}/${value.pro.slug_eng}">${value.pro.proname_eng}</a></div>
						<div class="rating">
            ...
            ${value.pro.discount_price == null ?
              `${value.pro.selling_price}` :

              `${value.pro.newprice}
              <span>${value.pro.selling_price}</span>`
					...
					<td class="col-md-2">
          <button  class="btn btn-primary icon" type="button" title='Add Cart' data-toggle="modal" data-target="#exampleModal"  id="${value.pro.id}" onclick="proview(this.id)"> <i class="fa fa-shopping-cart"></i> </button>
					</td>
					<td class="col-md-1 close-btn">
          <button id="${value.pro_id}" onclick='removewish(this.id)'>
