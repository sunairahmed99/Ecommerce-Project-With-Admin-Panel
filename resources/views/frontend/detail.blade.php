						...
						<div class="product-info">
							...
							<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
                                         @if($pro->pro_qty > 0 or $pro->pro_qty == 0 or $pro->pro_qty == null)
                            ...
                            @if(session()->get('language') == 'urdu') {{$pro->shortdesc_eng}}   @else {{$pro->shortdesc_urdu}}    @endif
                            ...
                            $sell = $pro->selling_price - $pro->discount_price;
                            $dis = ($sell/$pro->selling_price) * 100;
							...
							<span class="price-strike">{{$pro->selling_price}}</span>
							...
							<div class="quantity-container info-container">
								<div class="row">
                                   ...
                                   @if($pro->prosize_eng == null)

								   @else
									<div class='form-group' style='margin-left:20px'>
									<label for="">choose size</label>
										<select name="" id="size">
											@foreach($prosize as $prosize)
								   ...
								   <input type="hidden" id='product_id' value="{{$pro->id}}" min='1'>
									<div class="col-sm-7">
