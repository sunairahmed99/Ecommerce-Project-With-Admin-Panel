...
<div class='row' style="background-color:blue; margin:2rem; border-radius:20px; height:300px">
    <div class='col-md-4' style="color:white; padding-left:20px; padding-top:20px;">
        <h1>Name: {{Auth::user()->name}} </h1>
        <h1>Email: {{Auth::user()->email}} </h1>
        <h1>Phone: {{Auth::user()->phone}} </h1>
    </div>
    <a href="{{route('edit.profile')}}" class="btn btn-success" style="margin-top:20px; padding:10px" >Edit Profile</a>

    <div class='col-md-6 ml-3'>
        <img style="height:290px; width:280px; border:1px solid blue; border-radius:40%; margin-left:200px; margin-top:5px" src="{{(!empty(Auth::user()->profile_photo_path))? '' : url(asset('upload/no_image.jpg'))}}" alt="">
